...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { description: @rate.description, rating_type_id: @rate.rating_type_id, value: @rate.value }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { description: @rate.description, rating_type_id: @rate.rating_type_id, value: @rate.value }
    assert_redirected_to rate_path(assigns(:rate))
  end
